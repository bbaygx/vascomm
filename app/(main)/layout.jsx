...
export default function layouts({children}) {
      ...
      <nav>
        <div className='bg-white shadow-md h-16 flex gap-4 items-center justify-between px-3 sm:px-6'>
            ...
            <div className="hidden sm:block space-x-5">
              ...
              <Link href="/auth/daftar">Masuk</Link>
              </Button>
            </div>
          </div>
      </nav>
  ...
  >
      ...
      >
        <div>
          ...
          <ul className="mt-6 space-y-4 text-sm">
            {["Bantuan", "Tanya Jawab", "Hubungi Kami", "Cara Berjualan"]
             .map((item, i)=> (
                <li key={i}>
        ...
        <div>
          ...
          <ul className="mt-6 space-y-4 text-sm">
            {["About Us", "Karir", "Blog", "Kebijakan Privasi", "Syarat Dan Ketentuan", ]
              .map((item, i) => (
                <li key={i}>
                <Link href="#" className="text-gray-700 transition hover:opacity-75">
                  {item}
    ...
    <p className="text-xs text-gray-500">
      &copy; 2023. Vascomm. All rights reserved.
    </p>
  </div>
</footer>
